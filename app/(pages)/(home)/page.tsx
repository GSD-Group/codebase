    ...
    <div className=" rounded-full  ">
      ...
      <main>
        <div className="mx-auto max-w-7xl  px-4 sm:px-6 lg:px-8 pb-16 pt-20 text-center lg:pt-32">
          ...
          <TextGenerateEffect className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700" words="Invest in Commerce, We Handle the Commerce. Dive into the Amazon
